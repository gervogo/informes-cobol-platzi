      ...
      ******************************************************************
           ...
           PROGRAM-ID.                   PLATZI-CPCOBOL-PROJECT.
           *> Los siguientes parametros son opcionales, están deprecados hoy en día.
           AUTHOR.                       GERSON GÁLVEZ.
           ...
           CONFIGURATION SECTION.
               ...
               SELECT REPORTE             ASSIGN TU UT-S-REPORTE.
      ...
      *            05 WSS-FIN                  PIC X(03) VALUE SPACES.
           ...
           *> GUIONES SEPARADORES
               01  WSC-GUIONES.
                   05 FILLER                   PIC X(01).
                   05 FILLER                   PIC X(78) VALUE ALL '-'. *> REPITE CON '-'
                   05 FILLER                   PIC X(01) VALUE SPACES.

           *> DETALLE DE CADA ENCABEZADO REFERENTE AL CONTENIDO DEL REGISTRO DE ENTRADA DEL FICHERO DE ALUMNOS
               01  WSC-COL-DETA-1.
                   05 FILLER                   PIC X(03) VALUE SPACES.
           ...
           *> INFORMACIÓN AL FINAL DEL REPORTE
               ...
               01  WSV-DETALLE-IMPRESOS.
                   ...
                   05 FILLER                   PIC X(30) VALUE SPACES.
                   05 WSV-DET-BECA2            PIC $$$,$$$,$$9.99. *> OJO CON ESTO

           *> RECIBE LA INFO QUE NOS ENVIA EL JCL Y QUE HACE REFERENCIA A LA FECHA
               LINKAGE SECTION.
               01  LK-FECHA.
                   05 FILLER                   PIC X(02).
                   05 LK-DIA                   PIC 9(02).
               ...
               *> DEFINICIÓN DEL PARRAFO 010-INICIO
               010-INICIO.
               ...
               *> DEFINICIÓN DEL PARRAFO 020-ABRE-ARCHIVOS
               020-ABRE-ARCHIVOS.
                   OPEN INPUT  ALUMNO
                        OUTPUT REPORTE.
               020-FIN. EXIT.

               *> DEFINICIÓN DEL PARRAFO 030-TITULOS
               030-TITULOS.
                   WRITE REG-REPORTE           FROM WSC-TIT-1
                   MOVE LK-DIA                 TO WSC-TIT-2-DIA
                   MOVE LK-MES                 TO WSC-TIT-2-MES
                   MOVE LK-ANIO                TO WSC-TIT-2-ANIO
                   MOVE 1                      TO WSC-TITU-2-PAGINA
                   WRITE REG-REPORTE           FROM WSC-TIT-2 *> ESCRIBE EL CONTENIDO DE LA VARIABLE
               ...
               040-PROCESO.
                   ADD 010-INICIO              TO WSV-ALUMNOS-LEI
               ...
               050-CIF-CONTROL.
                   ...
                   DISPLAY ' '
                   DISPLAY '------------------ *** ----------------------'
                   DISPLAY '**   EL ARCHIVO DE ALUMNOS ESTÁ VACÍO,    ***'
                   DISPLAY '**   TERMINA EJECUCIÓN SIN PROCESAR DATOS. **'
                   DISPLAY '------------------ *** ----------------------'
                   DISPLAY ' '
              ...
              END PROGRAM PLATZI-CPCOBOL-PROJECT.
